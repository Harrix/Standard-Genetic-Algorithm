...
Генетический алгоритм. Стандарт. v.3.4.
...
В папке **_WorkingFiles** располагаются исходники рисунков из папки **images** для документа. 
...
Файл **_Standard-Genetic-Algorithm.tex** - это исходник pdf документа.
